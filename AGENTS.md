...
2. `docs/CREDIBILITY.md` — what tests prove / do **not** prove (CI VOID until Actions)
3. `lib/workflow-runtime.cjs` — DAG / budgets / retries / cancel / receipts
4. `tests/orchestration.test.cjs` — reliability contract (subset of donor)
5. `evals/README.md` — mechanical grader fixtures
